	...
	def show_info(self):
		...
		if accounts:
			for account in accounts:
				...
				print("Account Pin:", account[2])
				print("User Email:", account[3])
				print("User Phone Number:", account[4])
				print("Country:", account[5])
				print("Issue Date:", account[6])
				print("Expiry Date:", account[7])
				print("\n")
		else:
			print("\n Account not found.\n")
